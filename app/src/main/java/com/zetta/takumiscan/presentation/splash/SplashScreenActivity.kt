...
class SplashScreenActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            ...
            if (cacheController.isFirstTime()) intent = Intent(this, RegisterActivity::class.java)
            if (cacheController.isAlreadyRegister()) intent = Intent(this, MainActivity::class.java)
